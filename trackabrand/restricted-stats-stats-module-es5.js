...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["restricted-stats-stats-module"], {
  ...
  /***/
  function srcAppLayoutRestrictedStatsStatsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _map_visualization_map_visualization_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./map-visualization/map-visualization.component */
    ...
    var routes = [{
      ...
      path: 'map',
      component: _map_visualization_map_visualization_component__WEBPACK_IMPORTED_MODULE_3__["MapVisualizationComponent"]
    }];
    ...
    StatsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: StatsRoutingModule
    });
    StatsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function StatsRoutingModule_Factory(t) {
        return new (t || StatsRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](StatsRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](StatsRoutingModule, [{
  ...
  /***/
  function srcAppLayoutRestrictedStatsStatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_api_stats_stats_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/api/stats/stats.service */
    "./src/app/api/stats/stats.service.ts");

    function StatsComponent_option_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StatsComponent_div_10_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function StatsComponent_div_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
    ...
    function StatsComponent_ng_template_32_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var StatsComponent = /*#__PURE__*/function () {
      function StatsComponent(fb, statsService) {
        _classCallCheck(this, StatsComponent);

        this.fb = fb;
        this.statsService = statsService;
        this.isLineChart = true;
        this.selectorList = ["All scans", "Scans without authorization", "Total number of items"];
        this.allScans = [];
        this.years = [];
        this.sortedByMonth = [[], [], [], [], [], [], [], [], [], [], [], []];
        this.scansCount = [];
      ...
      _createClass(StatsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.typeForm.get("type").valueChanges.subscribe(function (f) {
            _this.onTypeChanged(f);
          });
        }
      }, {
        key: "getScans",
        value: function getScans() {
          var _this2 = this;

          this.statsService.getUserScans().subscribe(function (scanList) {
            _this2.allScans = scanList.map(function (e) {
              return _this2.parseScan(e);
            });

            _this2.sortByMonth();

            _this2.sortByLocation();
          });
        }
      }, {
        key: "sortByMonth",
        value: function sortByMonth() {
          var _this3 = this;

          this.allScans.forEach(function (scan) {
            _this3.sortedByMonth[scan.month].push(scan);
          });
          this.countMonthData();
        }
      }, {
        key: "countMonthData",
        value: function countMonthData() {
          var _this4 = this;

          var allProductsCount = 0;
          var allUnregistered = 0;
          this.sortedByMonth.forEach(function (monthArray) {
            var productIds = [];
            var authCount = 0;
            ...
            _this4.scansCount.push({
              count: monthArray.length,
              month: _this4.sortedByMonth.indexOf(monthArray)
            });

            _this4.productsCount.push({
              count: productIds.length,
              month: _this4.sortedByMonth.indexOf(monthArray)
            });

            _this4.scansWithoutAuth.push({
              count: authCount,
              month: _this4.sortedByMonth.indexOf(monthArray)
            });
          });
        ...
        value: function sortByLocation() {
          ...
          this.allScans.forEach(function (scan) {
            ...
            var index;
            var bool = pairs.some(function (e) {
            ...
            if (!bool) {
              ...
              _this5.sortedByLocation.push([scan]);
            } else {
              _this5.sortedByLocation[index].push(scan);
            }
          });
          this.countLocationData();
        }
      }, {
        key: "countLocationData",
        value: function countLocationData() {
          var _this6 = this;

          this.sortedByLocation.forEach(function (locArray) {
            var productIds = [];
            var authCount = 0;
            var latitude;
            var longitude;
            ...
            _this6.locScansCount.push({
              count: locArray.length,
              latitude: latitude,
              longitude: longitude
            });

            _this6.locProductsCount.push({
              count: productIds.length,
              latitude: latitude,
              longitude: longitude
            });
            ...
            if (authCount !== 0) {
              _this6.locScansWithoutAuth.push({
                count: authCount,
                latitude: latitude,
                longitude: longitude
              });
        ...
        key: "parseScan",
        value: function parseScan(scan) {
          return Object.assign(Object.assign({}, scan), {
            month: new Date(scan.time).getMonth(),
        ...
        key: "onTypeChanged",
        value: function onTypeChanged(value) {
    ...
    StatsComponent.ɵfac = function StatsComponent_Factory(t) {
      return new (t || StatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_stats_stats_service__WEBPACK_IMPORTED_MODULE_2__["StatsService"]));
    };
    ...
    StatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function StatsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StatsComponent_Template_button_click_5_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StatsComponent, [{
        ...
        return [{
          ...
          type: src_app_api_stats_stats_service__WEBPACK_IMPORTED_MODULE_2__["StatsService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppLayoutRestrictedStatsStatsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _stats_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var src_app_common_material_material_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/common/material/material.module */
    "./src/app/common/material/material.module.ts");
    /* harmony import */


    var angular_svg_round_progressbar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! angular-svg-round-progressbar */
    "./node_modules/angular-svg-round-progressbar/__ivy_ngcc__/fesm2015/angular-svg-round-progressbar.js");
    /* harmony import */


    var _map_visualization_map_visualization_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./map-visualization/map-visualization.module */
    "./src/app/layout/restricted/stats/map-visualization/map-visualization.module.ts");
    /* harmony import */


    var _line_visualization_line_visualization_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./line-visualization/line-visualization.module */
    ...
    var _map_visualization_map_visualization_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./map-visualization/map-visualization.component */
    "./src/app/layout/restricted/stats/map-visualization/map-visualization.component.ts");
    /* harmony import */


    var _line_visualization_line_visualization_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./line-visualization/line-visualization.component */
    ...
    var _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    ...
    var _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
    ...
    var angular_google_charts__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
    ...
    StatsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: StatsModule
    });
    StatsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function StatsModule_Factory(t) {
        return new (t || StatsModule)();
      },
      imports: [[_angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _map_visualization_map_visualization_module__WEBPACK_IMPORTED_MODULE_9__["MapVisualizationModule"], _line_visualization_line_visualization_module__WEBPACK_IMPORTED_MODULE_10__["LineVisualizationModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _stats_routing_module__WEBPACK_IMPORTED_MODULE_2__["StatsRoutingModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_3__["ChartsModule"], _angular_google_maps__WEBPACK_IMPORTED_MODULE_5__["GoogleMapsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientJsonpModule"], src_app_common_material_material_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], angular_svg_round_progressbar__WEBPACK_IMPORTED_MODULE_8__["RoundProgressModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](StatsModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StatsModule, [{
...
//# sourceMappingURL=restricted-stats-stats-module-es5.js.map