...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["restricted-admin-users-admin-users-module"], {
  ...
  /***/
  function srcAppLayoutRestrictedAdminUsersAdminUsersListAdminUsersListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdminUsersListComponent", function () {
    ...
    var _dialog_form_dialog_form_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../dialog-form/dialog-form.component */
    "./src/app/layout/restricted/admin-users/dialog-form/dialog-form.component.ts");
    /* harmony import */


    var _delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var src_app_api_user_user_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _animations_spinner_spinner_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../../../animations/spinner/spinner.component */
    ...
    function AdminUsersListComponent_th_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AdminUsersListComponent_td_16_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AdminUsersListComponent_th_18_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 17);
    ...
    function AdminUsersListComponent_td_19_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 18);
    ...
    function AdminUsersListComponent_th_21_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "th", 17);
      }
    }

    function AdminUsersListComponent_td_22_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminUsersListComponent_td_22_Template_button_click_1_listener() {
          ...
          return ctx_r14.openDialog(user_r13);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminUsersListComponent_td_22_Template_button_click_4_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);
          ...
          return ctx_r16.openDeleteUserDialog(user_r13);
        });
    ...
    function AdminUsersListComponent_tr_23_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 21);
      }
    }

    function AdminUsersListComponent_tr_24_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AdminUsersListComponent_mat_paginator_25_Template(rf, ctx) {
      if (rf & 1) {
        var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-paginator", 23);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function AdminUsersListComponent_mat_paginator_25_Template_mat_paginator_page_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r19);

          var ctx_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r18.pageEvent = $event;
        });
    ...
    function AdminUsersListComponent_div_26_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AdminUsersListComponent = /*#__PURE__*/function () {
      function AdminUsersListComponent(dialog, userService) {
        _classCallCheck(this, AdminUsersListComponent);
      ...
      _createClass(AdminUsersListComponent, [{
        key: "ngOnInit",
        ...
        value: function searchUser() {
          ...
          var data = this.elementData.filter(function (user) {
            var userName = user.name.toLowerCase();

            var search = _this.searchString.toLowerCase();
        ...
        key: "openDeleteUserDialog",
        value: function openDeleteUserDialog(user) {
          var _this2 = this;

          var dialogRef = this.dialog.open(_delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_4__["DeleteUserComponent"], {
            data: user
          });
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
              //Change the table data after deletion
              var data = _this2.elementData;
              _this2.elementData = data.filter(function (element) {
                return user !== element;
              });
              _this2.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this2.elementData);

              _this2.changePagination();
            }
          });
        }
      }, {
        ...
        value: function getUsers() {
          ...
          this.userService.getAllAdminUsers().subscribe(function (adminUsersList) {
            _this3.isLoading = false;
            _this3.elementData = adminUsersList;
            _this3.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](_this3.elementData); //Inserted SetTimeOut to wait till the datasource is updated

            setTimeout(function () {
              _this3.changePagination();
            }, 0);
          });
        }
      }]);
    ...
    AdminUsersListComponent.ɵfac = function AdminUsersListComponent_Factory(t) {
      return new (t || AdminUsersListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_api_user_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"]));
    };

    AdminUsersListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 6,
      consts: [[1, "header"], [1, "container-fluid"], ["mat-flat-button", "", "color", "accent", 3, "click"], [1, "wrapper"], [1, "search-input"], ["appearance", "outline"], ["matInput", "", "type", "text", 3, "ngModel", "keyup", "ngModelChange"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "position"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "username"], ["matColumnDef", "action"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], [3, "pageSize", "pageSizeOptions", "page", 4, "ngIf"], [4, "ngIf"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-icon-button", "", "color", "accent", "aria-label", "Edit", "matTooltip", "Edit", 3, "click"], ["mat-icon-button", "", "color", "warn", "aria-label", "Delete", "matTooltip", "Delete", 3, "click"], ["mat-header-row", ""], ["mat-row", ""], [3, "pageSize", "pageSizeOptions", "page"], [1, "loading"], [1, "bar"]],
      template: function AdminUsersListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AdminUsersListComponent_Template_button_click_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function AdminUsersListComponent_Template_input_keyup_11_listener() {
            return ctx.searchUser();
          })("ngModelChange", function AdminUsersListComponent_Template_input_ngModelChange_11_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminUsersListComponent, [{
        ...
        return [{
          ...
          type: src_app_api_user_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"]
        }];
      }, {
        paginator: [{
  ...
  /***/
  function srcAppLayoutRestrictedAdminUsersAdminUsersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _admin_users_list_admin_users_list_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./admin-users-list/admin-users-list.component */
    "./src/app/layout/restricted/admin-users/admin-users-list/admin-users-list.component.ts");
    /* harmony import */
    ...
    AdminUsersRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: AdminUsersRoutingModule
    });
    AdminUsersRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AdminUsersRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AdminUsersRoutingModule, [{
  ...
  /***/
  function srcAppLayoutRestrictedAdminUsersAdminUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _admin_users_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./admin-users-routing.module */
    "./src/app/layout/restricted/admin-users/admin-users-routing.module.ts");
    /* harmony import */


    var _admin_users_list_admin_users_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./admin-users-list/admin-users-list.component */
    "./src/app/layout/restricted/admin-users/admin-users-list/admin-users-list.component.ts");
    /* harmony import */


    var _dialog_form_dialog_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./dialog-form/dialog-form.component */
    "./src/app/layout/restricted/admin-users/dialog-form/dialog-form.component.ts");
    /* harmony import */


    var _animations_animations_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../animations/animations.module */
    "./src/app/layout/animations/animations.module.ts");
    /* harmony import */


    var _delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./delete-user/delete-user.component */
    "./src/app/layout/restricted/admin-users/delete-user/delete-user.component.ts");
    /* harmony import */
    ...
    AdminUsersModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: AdminUsersModule
    });
    AdminUsersModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function AdminUsersModule_Factory(t) {
        return new (t || AdminUsersModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _admin_users_routing_module__WEBPACK_IMPORTED_MODULE_4__["AdminUsersRoutingModule"], _common_material_material_module__WEBPACK_IMPORTED_MODULE_0__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _animations_animations_module__WEBPACK_IMPORTED_MODULE_7__["AnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialogModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AdminUsersModule, {
        declarations: [_admin_users_list_admin_users_list_component__WEBPACK_IMPORTED_MODULE_5__["AdminUsersListComponent"], _dialog_form_dialog_form_component__WEBPACK_IMPORTED_MODULE_6__["DialogFormComponent"], _delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_8__["DeleteUserComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _admin_users_routing_module__WEBPACK_IMPORTED_MODULE_4__["AdminUsersRoutingModule"], _common_material_material_module__WEBPACK_IMPORTED_MODULE_0__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _animations_animations_module__WEBPACK_IMPORTED_MODULE_7__["AnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialogModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AdminUsersModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"],
        args: [{
          declarations: [_admin_users_list_admin_users_list_component__WEBPACK_IMPORTED_MODULE_5__["AdminUsersListComponent"], _dialog_form_dialog_form_component__WEBPACK_IMPORTED_MODULE_6__["DialogFormComponent"], _delete_user_delete_user_component__WEBPACK_IMPORTED_MODULE_8__["DeleteUserComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _admin_users_routing_module__WEBPACK_IMPORTED_MODULE_4__["AdminUsersRoutingModule"], _common_material_material_module__WEBPACK_IMPORTED_MODULE_0__["MaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _animations_animations_module__WEBPACK_IMPORTED_MODULE_7__["AnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_9__["MatDialogModule"]]
...
//# sourceMappingURL=restricted-admin-users-admin-users-module-es5.js.map